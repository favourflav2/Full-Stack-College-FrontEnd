              ...
              {/* Inner Box */}
                  <Box className='w-[90%]  lg:w-[80%]  flex flex-col'>
                      <form className='flex flex-col w-full mt-8 ' onSubmit={(e)=>handleSubmit(e)}>
                        ...
                        <Typography className='flex justify-center text-3xl text-black font-extrabold'>Sign Up</Typography>
                      ...
                      <Box className="flex flex-col">
                          ...
                          <Box className="flex flex-col">
                            <label htmlFor="userName" className='text-black text-lg font-semibold mb-1'>Username :</label>
                            <input type="text" 
                              name='userName'
                          ...
                          <Box className="flex flex-col">
                            <label htmlFor="confirmPassword" className='text-black text-lg font-semibold mb-1'>Confirm Password :</label>
                            <input type="password" 
                      ...
                      <Box className='flex flex-col justify-center mt-8 mb-5'>
                          <button className='w-full bg-gray-300 hover:bg-blue-400 text-black rounded-lg text-xl font-bold' >Sign Up</button>

                          <Box className='flex justify-center mb-2 mt-3'>
                          <Typography className='text-black'>Already have an account? <Link to='/login'><span className='text-blue-400 border-b border-blue-400 hover:text-[18px] hover:text-blue-600 hover:border-blue-600'>Login</span></Link></Typography>
                          </Box>
                      </Box>
